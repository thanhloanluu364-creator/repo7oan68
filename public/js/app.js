...
document.getElementById('btn-submit-request').addEventListener('click', openClientModal);
document.getElementById('btn-submit-request-2').addEventListener('click', openClientModal);
        ...
        <form id="clientForm" class="space-y-3">
            ...
            <div class="mt-[15px] mb-[20px]">
                <label class="cursor-pointer flex items-center gap-[5px] text-[14px] " for="custom-checkbox">
                    ...
                    I agree with<a class="text-[#0d6efd] flex items-center gap-[5px] inline pointer-events-none" href="">Terms of use <img src="./public/meta/reject.svg" class="w-[10px] h-[10px] items-center inline" alt=""></a>
                </label>
            </div>
